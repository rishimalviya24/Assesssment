...
export default function ExamplesPage() {
  return (
    <section id="examples" className="bg-black pb-12 sm:pb-16">
      ...
      <p className="text-[13px] sm:text-[14px] text-white/60 px-5 sm:px-7 mt-5 mb-7" style={{fontFamily:'Arial,sans-serif'}}>
      ...
      <div className="flex flex-wrap items-center gap-4 sm:gap-7 px-5 sm:px-7 pt-8 sm:pt-9">
        ...
        {['GRAPHIC DESIGN','PHOTOGRAPHY','WEB DEVELOPMENT'].map((l,i) => (
          <a key={i} href="#" className="text-[12px] sm:text-[13px] font-bold tracking-[0.05em] text-white underline underline-offset-[3px] italic opacity-80 hover:opacity-100 transition-opacity" style={{fontFamily:'Arial,sans-serif'}}>{l}</a>
        ))}
      </div>
    </section>
  );
